...
const messages: Record<FeedbackLocale, FeedbackMessages> = {
  en: {
    ...
    closeReasonCompletedDescription: "Confirm resolved and close.",
    closeReasonNoLongerNeeded: "No longer needed",
    closeReasonNoLongerNeededDescription: "Close — no further action needed.",
  ...
  "zh-CN": {
    ...
    closeReasonCompletedDescription: "确认已解决并关闭。",
    closeReasonNoLongerNeeded: "不再需要处理",
    closeReasonNoLongerNeededDescription: "无需处理并关闭。",
