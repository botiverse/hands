...
// Apple notarization (broker-only platform feature).
...
admin.get("/api/apps/:appId/notarizations/:submissionId/log", requireAppRole("viewer"), handleNotarizationLog);
