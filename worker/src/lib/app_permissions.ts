...
export const APP_PERMISSION_DESCRIPTIONS: Record<AppPermission, string> = {
  ...
  "feedback:comment": "Post a public reply the reporter sees, and — for a token bound to a reporter integration — close or reopen any ticket its integration owns. Scope follows the token's binding.",
